      ...
      <Card className="bg-green-100 dark:bg-green-800">
        <CardContent className="flex items-center justify-between p-4">
          <div>
            ...
            <p className="text-2xl font-bold text-green-900 dark:text-green-50">${totalIncome}</p>
          </div>
      ...
      <Card className="bg-red-100 dark:bg-red-800">
        <CardContent className="flex items-center justify-between p-4">
          <div>
            ...
            <p className="text-2xl font-bold text-red-900 dark:text-red-50">${totalExpenses}</p>
          </div>
