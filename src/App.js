...
const FinanzasApp = () => {
  ...
  {editingTransaction && (
    <Button onClick={cancelEdit} className="mt-2 w-full bg-gray-500 hover:bg-gray-600">
      Cancelar Edición
    </Button>
  )}
  ...
  <Button onClick={() => addOrUpdateTransaction("ingreso")} className="flex-1 bg-green-500 hover:bg-green-600">
    <Plus className="mr-2 h-4 w-4" /> {editingTransaction ? "Actualizar" : "Ingreso"}
  </Button>
  <Button onClick={() => addOrUpdateTransaction("gasto")} className="flex-1 bg-red-500 hover:bg-red-600">
    <Minus className="mr-2 h-4 w-4" /> {editingTransaction ? "Actualizar" : "Gasto"}
  </Button>
  {editingTransaction && (
    <Button onClick={cancelEdit} className="flex-1 bg-gray-300 hover:bg-gray-400">
      Cancelar Edición
    </Button>
  )}
